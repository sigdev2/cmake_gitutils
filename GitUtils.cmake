        ...
        foreach(REMOTE_ARGS ${GIT_ARGS_REMOTES})
            ...
            if ((NOT ("${REMOTE_NAME}" STREQUAL "")) AND (NOT ("${REMOTE_URL}" STREQUAL "")))
                if (NOT DEFINED REMOTE_MAP_ITEM_${REMOTE_NAME})
                    get_filename_component(ABS_REMOTE_URL "${REMOTE_URL}" ABSOLUTE)
                    if (NOT ("${ABS_REMOTE_URL}" STREQUAL "${GIT_FOLDER}"))
                    ...
                    if (NOT ("${REMOTE_MAP}" STREQUAL ""))
                        ...
                        foreach(REMOTE_NAME ${REMOTE_MAP})
                            if (DEFINED REMOTE_MAP_ITEM_${REMOTE_NAME})
                                ...
                                execute_process(COMMAND git push ${REMOTE_NAME} ${SUBMODULE_ARG} WORKING_DIRECTORY ${GIT_FOLDER}/)
                                if ((DEFINED GIT_ARGS_PULL) AND (${GIT_ARGS_PULL}))
                                    message("    [PULL GIT] ${REMOTE_NAME}: ${REMOTE_MAP_ITEM_${REMOTE_NAME}}")
                                    execute_process(COMMAND git pull ${REMOTE_NAME} ${SUBMODULE_ARG} WORKING_DIRECTORY ${GIT_FOLDER}/)
                                endif()
                            endif()
                        endforeach()
